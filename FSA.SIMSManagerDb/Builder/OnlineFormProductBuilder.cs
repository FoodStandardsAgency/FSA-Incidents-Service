...
{
    internal class OnlineFormProductBuilder : AuditInfoBuilderConfiguration<OnlineFormProductDb>
    {
        public override void Configure(EntityTypeBuilder<OnlineFormProductDb> builder)
        {
